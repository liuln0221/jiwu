<template>
  <div class="album">
    ...
    <!-- 描述 -->
    <p class="album__desc">北京梵悦108相册图集，收集了全部梵悦108效果图、实景图、配套图、规划图、沙盘图、售楼处、位置交通图。同时也包含丰富的梵悦108样板房图片、装修效果图、家装设计图、精装样板间图片。让业主们通过这些梵悦108相关图片集，能更好，更快捷的了解北京梵悦108的详细信息。</p>
    <!-- 免责声明 -->
